...
export const ToggleRow = ({ label, detail, value, onChange }: Props) => {
  ...
  return <Pressable style={styles.row} onPress={() => onChange(!value)} accessibilityRole="checkbox" accessibilityState={{ checked: value }}>
...
const createStyles = (colours: AppColours) => StyleSheet.create({
  ...
  box: { width: 26, height: 26, borderRadius: 8, borderWidth: 2, borderColor: colours.inputBorder, alignItems: 'center', justifyContent: 'center' },
