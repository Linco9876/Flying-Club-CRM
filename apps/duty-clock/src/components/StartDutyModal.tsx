      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <View style={[styles.locationCard, geo.insideGeofence ? styles.locationInside : styles.locationOutside]}>
            ...
            <TextInput value={locationLabel} onChangeText={setLocationLabel} style={styles.input} placeholder="Where are you working?" />
            {!geo.insideGeofence ? (
              <>
                <Text style={styles.inputLabel}>Additional notes *</Text>
                <TextInput value={geofenceNotes} onChangeText={setGeofenceNotes} style={[styles.input, styles.textArea]} multiline placeholder="Why are you starting duty away from the club?" />
              </>
            ) : null}
          </View>
          ...
          <View style={styles.card}>
            ...
            {!sleepOpportunityConfirmed || (kssScore || 0) >= 7 ? (
              <>
                ...
                <TextInput value={privateNote} onChangeText={setPrivateNote} style={[styles.input, styles.textArea]} multiline placeholder="Add context and any mitigation." />
              </>
            ) : null}
          </View>
...
const styles = StyleSheet.create({
  ...
  locationInside: { backgroundColor: colours.greenLight, borderColor: '#ACDEC9' },
  locationOutside: { backgroundColor: colours.amberLight, borderColor: '#E9C588' },
  ...
  input: { minHeight: 48, borderWidth: 1, borderColor: '#C7D0D8', borderRadius: 13, paddingHorizontal: 13, fontSize: 15, color: colours.ink, backgroundColor: '#fff' },
  ...
  score: { width: 34, height: 34, borderRadius: 11, borderWidth: 1, borderColor: '#BBC5CE', alignItems: 'center', justifyContent: 'center' },
