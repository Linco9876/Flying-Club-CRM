...
export const SettingsDashboard: React.FC = () => {
  ...
  const allSections = useMemo<SettingsSection[]>(() => [
    ...
    { id: 'maintenance', label: 'Maintenance', category: 'Operations', keywords: ['defects', 'grounding', 'maintenance reminders', 'milestones'], icon: <Wrench className="h-4 w-4" />, roles: ['admin', 'senior_instructor', 'instructor'], component: MaintenanceSettings },
    ...
    { id: 'billing', label: 'Billing & Rates', category: 'Training & Billing', keywords: ['payment types', 'rates', 'payment methods', 'prepaid', 'charges', 'xero accounting code'], icon: <FileText className="h-4 w-4" />, roles: ['admin'], component: BillingRatesSettings },
    ...
    { id: 'account-info', label: 'Update My Info', category: 'Account & Preferences', keywords: ['my settings', 'update my info', 'profile', 'profile photo', 'profile picture', 'avatar', 'name', 'email', 'phone', 'emergency contact', 'preferred aircraft'], icon: <User className="h-4 w-4" />, roles: ['admin', 'senior_instructor', 'instructor', 'pilot', 'student'], component: UpdateMyInfoSettings },
