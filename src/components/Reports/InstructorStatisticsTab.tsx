            ...
            <article key={s.id} className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="shrink-0 text-right">
                  <p className="text-lg font-bold text-gray-900">{s.totalHoursInstructed.toFixed(1)}</p>
              ...
              <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                ...
                <div className="rounded-lg bg-green-50 p-2">
                  ...
                  <p className="font-bold text-green-900">{s.completedFlights}</p>
                </div>
                <div className="rounded-lg bg-teal-50 p-2">
                  <p className="text-xs text-teal-700">Students</p>
                  <p className="font-bold text-teal-900">{s.activeStudents}</p>
                </div>
              </div>
