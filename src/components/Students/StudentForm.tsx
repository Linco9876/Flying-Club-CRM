        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <p className="col-span-full text-sm text-slate-500">Manage certificates and declarations in the member file’s Medicals &amp; declarations section after saving the member.</p>
            </div>
          </div>
