...
const PortalSectionLoader = ({
  message = 'Loading this section',
  detail = 'Bringing the latest club information into view...',
  floating = false,
}: {
  message?: string;
  detail?: string;
...
const RouteTransitionLoader = ({ activeKey }: { activeKey: string }) => {
  ...
  return (
    <PortalSectionLoader
      ...
      detail="Getting the latest records ready..."
    />
  );
};
    ...
    <div className="relative z-10 min-h-screen">
      ...
      <div className="flex items-start lg:ml-0 ml-0">
        ...
        <main className={`${mainClassName} relative`}>
          <RouteTransitionLoader activeKey={activeSidebarView} />
