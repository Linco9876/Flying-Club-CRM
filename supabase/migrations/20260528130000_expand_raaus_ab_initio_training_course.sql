/*
  Expand the RAAus ab-initio course:
  - Add Trial Instruction Flight as the first lesson.
  - Include climbing turns in the medium turns lesson.
  - Add advanced turns.
  - Add scenario-based stalls.
*/
...
BEGIN
  ...
  IF target_course_id IS NULL THEN
    RAISE NOTICE 'RAAus ab-initio course not found; skipping expansion.';
    RETURN;
  END IF;
  ...
  SET
    ...
    description = 'Structured ab-initio course for the RAAus Recreational Pilot Certificate in Group A 3-axis aircraft. Starts with a Trial Instruction Flight, then progresses through separated core handling lessons, advanced handling, scenario-based stalls, circuits, emergencies, solo and RPC readiness. Exam requirements are called out in relevant lesson descriptions and recorded separately.',
    objectives = ARRAY[
      'Introduce prospective students through a safe Trial Instruction Flight before formal ab-initio progression',
      'Develop a safe ab-initio pilot from effects of controls through solo and RPC flight test readiness',
      'Cover RAAus Group A 3-axis core competencies including climbing turns, advanced turns, scenario-based stalls, circuits, forced landings, training area operations and abnormal situations',
  ...
  VALUES
  (target_course_id, 1, 'Trial Instruction Flight',
   'Provide a safe first instructional flight experience, introduce the student to the aircraft and local training environment, and identify any early training considerations.',
   '<ul><li>Welcome brief, safety briefing and aircraft entry/exit.</li><li>Basic cockpit orientation and use of headset/intercom.</li><li>Demonstration of attitude, horizon reference and gentle turns.</li><li>Student hands-on experience where appropriate.</li><li>Post-flight debrief and pathway discussion.</li></ul>',
   '<p>Trial Instruction Flight orientation. Keep expectations introductory; this lesson may be used before full enrolment but should still capture safety notes and student suitability observations.</p>',
   'raaus-abinitio-01', 'TIF', 'Trial Instruction Flight',
   'flight', 60, 'Introduce',
   ARRAY['Safety briefing', 'Aircraft orientation', 'Horizon reference', 'Gentle turns', 'Post-flight pathway discussion'],
   'Wear suitable clothing and bring any questions about learning to fly. No prior study required.',
   'Do not overload with formal grading. Record comfort, airsickness, communication, confidence, and any student file follow-up items.',
   pass_all),

  (target_course_id, 2, 'Effects of controls',
   ...
   'raaus-abinitio-02', '1.01-3', 'Effects of controls',
   'flight', 60, 'Introduce',
  ...
  (target_course_id, 3, 'Straight and level',
   ...
   'raaus-abinitio-03', '1.01-4', 'Straight and level',
   'flight', 75, 'Introduce',
  ...
  (target_course_id, 4, 'Climbing and descending',
   ...
   'raaus-abinitio-04', '1.01-5', 'Climbing and descending',
   'flight', 75, 'Practice',
  ...
  (target_course_id, 5, 'Medium turns, climbing turns and descending turns',
   'Teach coordinated level, climbing and descending turns with correct lookout, balance and altitude or performance control.',
   '<ul><li>Lookout and clearing turns.</li><li>Medium level turns.</li><li>Climbing turns.</li><li>Descending turns.</li><li>Roll-out anticipation, balance and overbanking awareness.</li></ul>',
   '<p>RAAus Unit 1.01 turning. Include balance, climbing turns, descending turns, load factor awareness and overbanking tendencies.</p>',
   'raaus-abinitio-05', '1.01-6', 'Turning',
   'flight', 90, 'Practice',
   ARRAY['Lookout before turn', 'Coordinated entry', 'Medium turns', 'Climbing turns', 'Descending turns', 'Roll-out anticipation'],
   'Revise angle of bank, rudder coordination, lookout technique and climb/descent attitudes.',
   'Do not progress until lookout is habitual before and during turns, including in climbing turns.',
   pass_all),

  (target_course_id, 6, 'Advanced turns',
   'Develop steeper turn handling, energy awareness, lookout discipline and recovery from poor turn coordination or altitude control.',
   '<ul><li>Steepening and reducing angle of bank.</li><li>Steep turn entry, maintenance and recovery within aircraft/CFI limits.</li><li>Energy and load factor awareness.</li><li>Recovery from descending, climbing or poorly coordinated turn trends.</li></ul>',
   '<p>Advanced turning consolidates RAAus Group A handling before more complex circuit, emergency and test-profile work. Keep manoeuvres within POH, CFI and FOM limitations.</p>',
   'raaus-abinitio-06', '1.01-6A', 'Advanced turns',
   'flight', 90, 'Practice',
   ARRAY['Steeper turns', 'Load factor awareness', 'Energy management', 'Turn recovery', 'Lookout discipline'],
   'Revise medium turns, balance and stall speed increase with load factor.',
   'This is not an aerobatic lesson. Emphasise controlled, coordinated manoeuvring and early recovery from developing errors.',
   pass_all),

  (target_course_id, 7, 'Slow flight and basic stalls',
   'Introduce slow flight, stall symptoms, stall entry and standard stall recovery within aircraft and CFI limitations.',
   '<ul><li>Slow flight and symptoms approaching the stall.</li><li>Stall entry and recovery in approved configurations.</li><li>Minimum safe height discipline.</li><li>UPRT awareness: unload, roll wings level, recover.</li></ul>',
   '<p>RAAus Unit 1.01 stalling. Cover angle of attack, load factor, stall speed variables and minimum safe heights.</p>',
   'raaus-abinitio-07', '1.01-7', 'Stalling',
   'flight', 90, 'Practice',
   ARRAY['Slow flight', 'Stall recognition', 'Standard stall recovery', 'Minimum height discipline', 'UPRT awareness'],
  ...
  (target_course_id, 8, 'Scenario-based stalls',
   'Apply stall recognition and recovery to realistic operational scenarios such as base-to-final, go-around, distraction and configuration changes.',
   '<ul><li>Scenario briefing and threat identification.</li><li>Approach-to-stall recognition in operational contexts.</li><li>Recovery from incipient stall cues with minimum height loss.</li><li>Decision making after recovery: go-around, abandon exercise or reconfigure.</li></ul>',
   '<p>Scenario-based stalls should reinforce avoidance, early recognition and recovery. Use only aircraft-approved configurations and CFI-authorised profiles.</p>',
   'raaus-abinitio-08', '1.01-7S', 'Scenario-based stalls',
   'flight', 90, 'Assess',
   ARRAY['Base-to-final scenario', 'Go-around scenario', 'Distraction management', 'Early recovery', 'Post-recovery decision'],
   'Review stall symptoms, circuit threats and why stalls occur in operational situations.',
   'Keep scenarios realistic and conservative. The learning goal is avoidance and early recovery, not surprise or startle training.',
   pass_all),

  (target_course_id, 9, 'Circuit introduction, take-off, approach and landing',
   ...
   'raaus-abinitio-09', '1.01-8.1/8.3', 'Circuit introduction',
   'flight', 90, 'Introduce',
  ...
  (target_course_id, 10, 'Go-around and continued circuits',
   ...
   'raaus-abinitio-10', '1.01-8.6', 'Go-around procedures',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 11, 'Circuit consolidation and circuit emergencies',
   ...
   'raaus-abinitio-11', '1.01-8.5', 'Circuit emergencies and precautions',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 12, 'First solo and supervised solo circuit consolidation',
   ...
   'raaus-abinitio-12', 'SOLO-1', 'First solo and supervised solo circuits',
   'flight', 60, 'Assess',
  ...
  (target_course_id, 13, 'Training area operations and radio procedures',
   ...
   'raaus-abinitio-13', '1.01-10 / 2.04', 'Training area operations and radio',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 14, 'Forced landing, glide approaches and sideslip awareness',
   ...
   'raaus-abinitio-14', '1.01-9.2/9.3', 'Forced landings and sideslip',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 15, 'Precautionary search and landing',
   ...
   'raaus-abinitio-15', '1.01-9.4', 'Precautionary search and landing',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 16, 'Abnormal situations and emergency management',
   ...
   'raaus-abinitio-16', '1.01-11', 'Manage abnormal situations and emergencies',
   'flight', 90, 'Practice',
  ...
  (target_course_id, 17, 'RPC consolidation: flight test profile practice',
   ...
   'raaus-abinitio-17', 'RPC-CONSOL', 'RPC consolidation',
   'flight', 120, 'Assess',
  ...
  (target_course_id, 18, 'CFI recommendation and Pilot Certificate readiness review',
   ...
   'raaus-abinitio-18', 'RPC-REVIEW', 'Pilot Certificate readiness review',
   'flight', 90, 'Assess',
